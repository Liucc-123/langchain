...
![](https://cdn.nlark.com/yuque/0/2025/png/32427128/1760971765289-4726e436-33be-401e-a4d7-4c66ebe5532a.png)
...
![](images\image-20250620153904265.png)
...
![](images\image-20250620154158019.png)

 下载后依据指引进行 Miniconda 安装。

### 2.2 Anaconda的使用方式
#### 2.2.1 使用方式一： Anaconda Powershell Prompt终端
![](images\image-20250620155921995.png)

安装完成后，打开终端 `Anaconda Powershell Prompt,` 如果有看到命令列提示中的 (base)，那表示安装成功。

![](images\image-20250620160202860.png)

我们可以輸入 `python --version`确认 Python版本。

![](images\image-20250620160612630.png)

#### 2.2.2 使用方式二：环境变量→cmd终端使用
1. 若在安装时**勾选添加环境变量**，会在用户环境变量的Path中添加相应路径；若安装时没有勾选添加环境变量，则需要在安装后手动添加环境变量。Windows操作系统下同时按下“Win+S”打开搜索栏，搜索“编辑系统环境变量”可进入查看和编辑环境变量。![](images\编辑系统环境变量.png)
...
4. 按下“Win+R”，输入“cmd”，点击确定，打开命令提示符
     ...
     ![](images\image-20250620165046595.png)
...
![](images\image-20250613170804298.png)
...
![](images\image-20250613170833376.png)
...
![](images\image-20250613170847862.png)
